...
/// If it is not, an INVALID_VALUE error is generated.
#[derive(Debug, Clone, ReferenceType)]
pub struct EXT_texture_compression_bptc(Reference);

impl EXT_texture_compression_bptc {

    pub const COMPRESSED_RGBA_BPTC_UNORM_EXT: GLenum = 36492;
    pub const COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT: GLenum = 36494;
    pub const COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT: GLenum = 36495;
    pub const COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT: GLenum = 36493;
}
...
/// If it is not, an INVALID_VALUE error is generated.
#[derive(Debug, Clone, ReferenceType)]
pub struct EXT_texture_compression_rgtc(Reference);

impl EXT_texture_compression_rgtc {

    pub const COMPRESSED_RED_GREEN_RGTC2_EXT: GLenum = 36285;
    pub const COMPRESSED_RED_RGTC1_EXT: GLenum = 36283;
    pub const COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT: GLenum = 36286;
    pub const COMPRESSED_SIGNED_RED_RGTC1_EXT: GLenum = 36284;
}
...
/// Shader compilation and program linking may be performed in a separate CPU thread. This extension provides a mechanism for the application to provide a hint to limit the number of threads it wants to be used to compile shaders, as well as a query to determine if the compilation process is complete.
#[derive(Debug, Clone, ReferenceType)]
pub struct KHR_parallel_shader_compile(Reference);

impl KHR_parallel_shader_compile {

    pub const COMPLETION_STATUS_KHR: GLenum = 37297;
    pub const MAX_SHADER_COMPILER_THREADS_KHR: GLenum = 37296;

    pub fn max_shader_compiler_threads_khr(&self, count: GLuint) {
        js!( @(no_return) @{self}.maxShaderCompilerThreadsKHR(@{count}); );
    }
}
...
impl Extension for EXT_texture_compression_rgtc {
    const NAME: &'static str = "EXT_texture_compression_rgtc";
}
...
impl Extension for KHR_parallel_shader_compile {
    const NAME: &'static str = "KHR_parallel_shader_compile";
}
