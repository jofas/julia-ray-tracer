...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "jrt-wasm.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "jrt-wasm.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'jrt_wasm'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'jrt_wasm':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_8aaa82509eb85917e6a9e00f08f7254078df151c": function($0) {
                var o = Module.STDWEB_PRIVATE.acquire_js_reference( $0 );return (o instanceof WebGLVertexArrayObject) | 0;
            },
            ...
            "__cargo_web_snippet_b114e4012733e5c4a59cacf9e2768ad3f5d6daef": function($0, $1, $2) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);($0).uniform3fv(($1),($2));
            },
            "__cargo_web_snippet_bd44e5fdbcc7e201553a77db9e0606f3a5bdc782": function() {
                console.log("no webgl2 support!");fallback();
            },
